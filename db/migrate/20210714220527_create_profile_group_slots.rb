class CreateProfileGroupSlots < ActiveRecord::Migration[6.1]
  def change
    create_table :profile_group_slots, id: :uuid do |t|
      ...
      t.belongs_to :character, null: false, foreign_key: true, type: :uuid
      t.belongs_to :slot_status, null: false, foreign_key: { to_table: :field_descriptors }, type: :uuid, default: ''
