class SystemMapController < ApplicationController
  ...
  def list
    ...
    render status: 200, json: SystemMapSystem.all.as_json(include: {
        ...
        system_objects: { include: { flora: {}, fauna: {}, observations: {}, discovered_by: { only: [], methods: [:main_character] }, system_map_images: { include: { created_by: { only: [], methods: [:main_character] } } }, object_type: {}, locations: { methods: [:primary_image_url] }, atmo_compositions: { include: { atmo_gas: {} } } }, methods: [:primary_image_url] },
        planets: { include: { flora: {}, fauna: {}, settlements: { include: { locations: { methods: [:primary_image_url] } }, methods: [:primary_image_url] }, observations: {}, discovered_by: { only: [], methods: [:main_character] }, system_map_images: { include: { created_by: { only: [], methods: [:main_character] } } }, locations: { include: { system_map_images: { include: { created_by: { only: [], methods: [:main_character] } } } }, methods: [:primary_image_url] }, moons: { include: { flora: {}, fauna: {}, settlements: { include: { locations: { methods: [:primary_image_url] } }, methods: [:primary_image_url] }, observations: {}, discovered_by: { only: [], methods: [:main_character] }, system_map_images: { include: { created_by: { only: [], methods: [:main_character] } } }, locations: { methods: [:primary_image_url] }, moon_types: {}, system_objects: { include: { flora: {}, fauna: {}, object_type: {}, locations: { methods: [:primary_image_url] } }, methods: [:primary_image_url] }, atmo_compositions: { include: { atmo_gas: {} } } }, methods: [:primary_image_url] }, planet_types: {}, system_objects: { include: { flora: {}, fauna: {}, object_type: {}, locations: { methods: [:primary_image_url] } }, methods: [:primary_image_url] }, atmo_compositions: { include: { atmo_gas: {} } } }, methods: [:primary_image_url] },
        gravity_wells: { include: { observations: {}, discovered_by: { only: [], methods: [:main_character] }, system_map_images: { include: { created_by: { only: [], methods: [:main_character] } } }, gravity_well_type: { }, luminosity_class: { } }, methods: [:primary_image_url] } },
        methods: :jump_points)
