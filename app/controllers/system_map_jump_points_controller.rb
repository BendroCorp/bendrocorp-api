class SystemMapJumpPointsController < ApplicationController
  ...
  def index
    ...
    render json: @system_map_jump_points.as_json(include: { system_one: { }, system_two: { }, connection_size: { }, connection_status: { } }, methods: [:kind, :primary_image_one_url, :primary_image_one_url_full, :primary_image_two_url, :primary_image_url_two_full])
  end

  # GET /system_map_jump_points/1
  def show
    if @system_map_jump_point
      render json: @system_map_jump_point.as_json(include: { system_one: { }, system_two: { }, connection_size: { }, connection_status: { } }, methods: [:kind, :primary_image_one_url, :primary_image_one_url_full, :primary_image_two_url, :primary_image_url_two_full])
    else
