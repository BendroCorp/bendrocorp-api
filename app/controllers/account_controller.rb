  ...
  def forgot_password
    ...
    if @user && @user.login_allowed
      ...
      if @user.save
        ...
        send_email(@user.email, "BendroCorp - Forgotten Password", "<h1>Forgot Your Password..?</h1><p>No worries. Just click the link below and you will be able to reset your password.</p><br /><p><a href=\'https://bendrocorp.app/forgot-password/#{new_token}\'>Password Reset</a></p>")
      end
    end
