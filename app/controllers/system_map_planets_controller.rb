class SystemMapPlanetsController < ApplicationController
  ...
  def index
    ...
    .to_json(include: { settlements: {}, locations: {}, moons: {}, system_objects: {}, faction_affiliation: {}, jurisdiction: {} }, methods: [:kind, :primary_image_url, :parent, :title_with_kind])
  ...
  def show
    if @system_map_planet
      render json: @system_map_planet.to_json(include: { settlements: {}, locations: {}, moons: {}, system_objects: {}, faction_affiliation: {}, jurisdiction: {} }, methods: [:kind, :primary_image_url, :parent, :title_with_kind])
    else
  ...
  def create
    ...
    if @system_map_planet.save
      render json: @system_map_planet.to_json(include: { settlements: {}, locations: {}, moons: {}, system_objects: {}, faction_affiliation: {}, jurisdiction: {} }, methods: [:kind, :primary_image_url, :parent, :title_with_kind]), status: :created
    else
  ...
  def update
    if @system_map_planet
      ...
      if @system_map_planet.update(system_map_planet_params)
        render json: @system_map_planet.to_json(include: { settlements: {}, locations: { include: { mission_givers: {} } }, moons: {}, system_objects: {}, faction_affiliation: {}, jurisdiction: {} }, methods: [:kind, :primary_image_url, :parent, :title_with_kind])
      else
        render json: { message: @system_map_planet.errors.full_messages.to_sentence }, status: :unprocessable_entity
      end
    else
