class SystemMapSystemPlanetaryBodyLocation < ApplicationRecord
  ...
  belongs_to :location_type, :class_name => 'SystemMapSystemPlanetaryBodyLocationType', :foreign_key => 'location_type_id'
  ...
  belongs_to :on_settlement, :class_name => 'SystemMapSystemSettlement', :foreign_key => 'on_settlement_id'
